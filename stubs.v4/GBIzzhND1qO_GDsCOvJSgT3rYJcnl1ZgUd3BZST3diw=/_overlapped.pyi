...
class Overlapped(_mod_builtins.object):
    ...
    def ReadFileInto(self, handle, buf):
    ...
    def WSARecvFrom(self):
        'RecvFile(handle, size, flags) -> Overlapped[(message, (host, port))]\n\nStart overlapped receive'
        pass
    
    def WSARecvInto(self, handle, buf, flags):
    ...
    def WSASendTo(self, handle, buf, flags, address_as_bytes):
...
def WSAConnect(client_handle, address_as_bytes):
    'WSAConnect(client_handle, address_as_bytes) -> Overlapped[None]\n\nBind a remote address to a connectionless (UDP) socket'
    pass

__doc__ = None
__file__ = 'c:\\python38\\dlls\\_overlapped.pyd'
